			...
			<div class="panel-body panel-content-padding">
				<div class="wcmp_form1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9">
                            <textarea   name="vendor_profile_data[Address]" class="no_input form-control" value="<?php echo isset($user->Address)? $user->Address: ''; ?>"  placeholder="<?php _e('Enter your Address here', 'dc-woocommerce-multi-vendor'); ?>"></textarea>
                        </div>  
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3 col-md-3"><?php _e('Contact', 'dc-woocommerce-multi-vendor'); ?></label>
                        <div class="col-md-6 col-sm-9">
                            <input class="no_input form-control" type="text" name="vendor_profile_data[Contact]" value="<?php echo isset($user->Contact)? $user->Contact : ''; ?>"  placeholder="<?php _e('Enter your Contact here', 'dc-woocommerce-multi-vendor'); ?>">
                        </div>  
                    </div>
                    <div class="form-group">
